...
const CreateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage(err.response?.data?.message ?? err.message ?? "Неизвестная ошибка");
      setModal("error");
    }
  };
    ...
    <div className="container py-10 px-4">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-sm w-full mx-4 text-center">
            {modal === "success" ? (
              <>
                ...
                <p className="text-gray-500 text-sm mb-6">Новый товар успешно добавлен в каталог.</p>
              </>
            ) : (
              <>
      ...
      >
        ...
        <button
          ...
          className="w-full bg-[#0074d4] hover:bg-[#005fad] text-white font-semibold py-3 rounded-lg transition text-sm tracking-wide cursor-pointer"
        >
          Создать товар
        </button>
      </form>
